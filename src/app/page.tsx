      ...
      <section id="contact" className="py-20 px-6 bg-pink-50">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="mt-10 pt-8 border-t border-pink-200">
            ...
            <a
              href="https://calendar.google.com/calendar/appointments/schedules/glamourgirlscleaning@gmail.com"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-white border-2 border-pink-200 text-pink-700 px-6 py-3 rounded-full font-semibold hover:bg-pink-50 transition"
            >
              <svg
                className="w-5 h-5"
                fill="none"
